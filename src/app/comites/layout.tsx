...
function IconDashboard({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7" rx="1" /><rect x="14" y="3" width="7" height="7" rx="1" /><rect x="3" y="14" width="7" height="7" rx="1" /><rect x="14" y="14" width="7" height="7" rx="1" /></svg>
}
function IconCalendar({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" /><path d="M16 2v4M8 2v4M3 10h18" /></svg>
}
function IconFolder({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z" /></svg>
}
function IconUsers({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75" /></svg>
}
function IconClock({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><path d="M12 6v6l4 2" /></svg>
}
function IconUserCog({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" /><circle cx="8.5" cy="7" r="4" /><path d="M20 8v6M23 11h-6" /></svg>
}
function IconUser({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2" /><circle cx="12" cy="7" r="4" /></svg>
}
function IconBell({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9M13.73 21a2 2 0 01-3.46 0" /></svg>
}
function IconSwitch({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><path d="M16 3l4 4-4 4M20 7H4M8 21l-4-4 4-4M4 17h16" /></svg>
}
function IconGear({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3" /><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06A1.65 1.65 0 004.68 15a1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 012.83-2.83l.06.06A1.65 1.65 0 009 4.68a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 2.83l-.06.06A1.65 1.65 0 0019.4 9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z" /></svg>
}
function IconHome({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z" /><polyline points="9 22 9 12 15 12 15 22" /></svg>
}
function IconGrid({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7" /><rect x="14" y="3" width="7" height="7" /><rect x="14" y="14" width="7" height="7" /><rect x="3" y="14" width="7" height="7" /></svg>
}
function IconPower({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><path d="M18.36 6.64a9 9 0 11-12.73 0M12 2v10" /></svg>
}
function IconChevronRight({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><path d="M9 18l6-6-6-6" /></svg>
}
function IconChevronLeft({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><path d="M15 18l-6-6 6-6" /></svg>
}
function IconPlay({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><polygon points="5 3 19 12 5 21 5 3" /></svg>
}
function IconDownload({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M7 10l5 5 5-5M12 15V3" /></svg>
}
function IconSearch({ className = 'w-4 h-4' }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8" /><path d="M21 21l-4.35-4.35" /></svg>
}
...
const SIDEBAR_SECTIONS: NavSection[] = [
  { title: 'Principal', items: [
    { href: '/comites', label: 'Comités', icon: 'dashboard' },
    { href: '/comites/reuniones-obra', label: 'Reuniones', icon: 'calendar', sub: [{ href: '/comites/reuniones-obra', label: 'Obra–Gerencia' }] },
  ] },
  { title: 'Gestión', items: [
    { href: '/comites/proyectos', label: 'Proyectos', icon: 'folder' },
    { href: '/comites/equipos', label: 'Equipos', icon: 'users' },
    { href: '/comites/historial', label: 'Historial', icon: 'clock' },
  ] },
  { title: 'Administración', items: [
    { href: '/comites/usuarios', label: 'Usuarios', icon: 'user-cog' },
  ] },
]
...
const SPEED_DIAL_ACTIONS: Record<string, { label: string; icon: string }[]> = {
  reuniones: [
    ...
    { label: 'Agendar reunion', icon: 'play' },
    { label: 'Compartir acta', icon: 'download' },
  ],
  default: [
...
const PROFILE_MENU = [
  ...
  { label: 'Cambiar proyecto', icon: 'switch' },
              ...
              return (
                <div key={item.href}>
                  <Link href={item.href}
                    ...
                    <span className="opacity-60 group-hover:opacity-100 transition-opacity">{ICON_MAP[item.icon] ? ICON_MAP[item.icon]({ className: 'w-4 h-4' }) : item.icon}</span>
                    {!collapsed && (
                      <>
    ...
    <div className="min-h-screen flex" style={{ background: '#F9FAFB' }}>
      ...
      <aside className={`hidden lg:flex flex-col fixed top-0 left-0 h-screen z-40 transition-all ${sidebarCollapsed ? 'w-[64px]' : 'w-[240px]'}`}
        ...
        <button onClick={() => setSidebarCollapsed(!sidebarCollapsed)}
          ...
          {sidebarCollapsed ? <IconChevronRight className="w-3 h-3" /> : <IconChevronLeft className="w-3 h-3" />}
        </button>
      </aside>
            ...
            <motion.aside initial={{ x: -300 }} animate={{ x: 0 }} exit={{ x: -300 }} transition={{ type: 'spring', damping: 25, stiffness: 300 }}
              ...
              <div className="px-3 pt-4 pb-2">
                <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-[#F3F4F6]">
                  <span className="text-[#9CA3AF]"><IconSearch className="w-4 h-4" /></span>
          ...
          {showSubTabs && (
            <div className="px-2 sm:px-4 py-1 flex items-center gap-0.5 overflow-x-auto scrollbar-hide border-b bg-white"
              ...
              <Link href={`/comites/${currentArea}/proyectar`}
                className="ml-1 text-center px-3 py-1 rounded text-[11px] font-semibold whitespace-nowrap transition-all text-cobalt bg-cobalt-light border border-cobalt/20 hover:bg-cobalt hover:text-white hover:border-cobalt">
                Presentar →
              </Link>
            </div>
          )}
                ...
                <div className="space-y-1">
                  {PROFILE_MENU.map(item => (
                    <button key={item.label} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl bg-white border border-[#E5E7EB] text-left hover:bg-[#F9FAFB] transition-colors">
                      <span className="opacity-50">{ICON_MAP[item.icon] ? ICON_MAP[item.icon]({ className: 'w-4 h-4' }) : item.icon}</span>
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-40 h-[64px] ccd-bottom-nav flex items-center justify-around px-4 safe-area-pb">
        ...
        <button onClick={() => { setMobileTab('home'); router.push('/comites') }}
          ...
          <span className={`${mobileTab === 'home' ? '' : 'opacity-40'}`}><IconHome className="w-5 h-5" /></span>
        ...
        <button onClick={() => { setMobileTab('module'); if (isHome) router.push('/comites/finanzas') }}
          ...
          <span className={`${mobileTab === 'module' ? '' : 'opacity-40'}`}><IconGrid className="w-5 h-5" /></span>
        ...
        <button onClick={() => setMobileTab('profile')}
          ...
          <span className={`${mobileTab === 'profile' ? '' : 'opacity-40'}`}><IconUser className="w-5 h-5" /></span>
                ...
                {(SPEED_DIAL_ACTIONS[currentModule] || SPEED_DIAL_ACTIONS.default).map((action, i) => (
                  <motion.button key={action.label}
                    ...
                    <span className="w-11 h-11 rounded-full flex items-center justify-center text-white font-bold shadow-lg"
                      ...
                      {action.icon === 'play' ? <IconPlay className="w-4 h-4" /> : action.icon === 'download' ? <IconDownload className="w-4 h-4" /> : action.icon}
                    </span>
                  </motion.button>
                ))}
              </div>
